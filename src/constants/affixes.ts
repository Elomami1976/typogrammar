...
export const PREFIX_CATEGORIES: AffixCategory[] = [
  {
    ...
    affixes: [
      ...
      { affix: 'counter-', meaning: 'opposite, against', example: 'act → <span class="font-bold">counter</span>act' },
      { affix: 'mal-', meaning: 'bad, wrong', example: 'function → <span class="font-bold">mal</span>function' },
      { affix: 'pseudo-', meaning: 'false, fake', example: 'science → <span class="font-bold">pseudo</span>science' },
    ],
  },
  {
    ...
    affixes: [
      ...
      { affix: 'neo-', meaning: 'new, modern', example: 'classical → <span class="font-bold">neo</span>classical' },
      { affix: 'ex-', meaning: 'former, out of', example: 'president → <span class="font-bold">ex</span>-president' },
      { affix: 'mid-', meaning: 'middle', example: 'night → <span class="font-bold">mid</span>night' },
    ],
  },
  {
    ...
    affixes: [
      ...
      { affix: 'quad-', meaning: 'four', example: 'rant → <span class="font-bold">quad</span>rant' },
      { affix: 'penta-', meaning: 'five', example: 'gon → <span class="font-bold">penta</span>gon' },
      { affix: 'hexa-', meaning: 'six', example: 'gon → <span class="font-bold">hexa</span>gon' },
      { affix: 'deca-', meaning: 'ten', example: 'de → <span class="font-bold">deca</span>de' },
      { affix: 'cent-', meaning: 'hundred', example: 'ury → <span class="font-bold">cent</span>ury' },
    ],
  },
  {
    ...
    affixes: [
      ...
      { affix: 'circum-', meaning: 'around', example: 'stance → <span class="font-bold">circum</span>stance' },
      { affix: 'intra-', meaning: 'within', example: 'net → <span class="font-bold">intra</span>net' },
      { affix: 'extra-', meaning: 'outside, beyond', example: 'ordinary → <span class="font-bold">extra</span>ordinary' },
      { affix: 'para-', meaning: 'beside, beyond', example: 'normal → <span class="font-bold">para</span>normal' },
      { affix: 'tele-', meaning: 'distant, far', example: 'phone → <span class="font-bold">tele</span>phone' },
    ],
  },
  {
    category: 'Size & Degree Prefixes',
    description: 'These prefixes indicate size, amount, or degree of something.',
    affixes: [
      { affix: 'over-', meaning: 'too much, excessively', example: 'sleep → <span class="font-bold">over</span>sleep' },
      { affix: 'under-', meaning: 'below, insufficiently', example: 'estimate → <span class="font-bold">under</span>estimate' },
      { affix: 'out-', meaning: 'surpassing, external', example: 'perform → <span class="font-bold">out</span>perform' },
      { affix: 'ultra-', meaning: 'beyond, extremely', example: 'violet → <span class="font-bold">ultra</span>violet' },
      { affix: 'hyper-', meaning: 'over, above', example: 'active → <span class="font-bold">hyper</span>active' },
      { affix: 'mega-', meaning: 'large, million', example: 'byte → <span class="font-bold">mega</span>byte' },
      { affix: 'micro-', meaning: 'small, millionth', example: 'scope → <span class="font-bold">micro</span>scope' },
      { affix: 'mini-', meaning: 'small', example: 'bus → <span class="font-bold">mini</span>bus' },
      { affix: 'macro-', meaning: 'large', example: 'economics → <span class="font-bold">macro</span>economics' },
      { affix: 'nano-', meaning: 'extremely small, billionth', example: 'technology → <span class="font-bold">nano</span>technology' },
    ],
  },
];
...
export const SUFFIX_CATEGORIES: AffixCategory[] = [
  {
    ...
    affixes: [
      ...
      { affix: '-dom', meaning: 'state, realm, condition', example: 'free → free<span class="font-bold">dom</span>' },
      { affix: '-age', meaning: 'action, result, collection', example: 'pack → pack<span class="font-bold">age</span>' },
      { affix: '-ure', meaning: 'action, process', example: 'fail → fail<span class="font-bold">ure</span>' },
      { affix: '-ee', meaning: 'one who receives', example: 'employ → employ<span class="font-bold">ee</span>' },
      { affix: '-ian', meaning: 'person concerned with', example: 'music → music<span class="font-bold">ian</span>' },
      { affix: '-ism', meaning: 'belief, practice, condition', example: 'capital → capital<span class="font-bold">ism</span>' },
    ],
  },
  {
    ...
    affixes: [
      ...
      { affix: '-ant, -ent', meaning: 'being in a state', example: 'import → import<span class="font-bold">ant</span>, differ → differ<span class="font-bold">ent</span>' },
      { affix: '-like', meaning: 'resembling', example: 'life → life<span class="font-bold">like</span>' },
      { affix: '-proof', meaning: 'protected against', example: 'water → water<span class="font-bold">proof</span>' },
      { affix: '-bound', meaning: 'restricted to', example: 'home → home<span class="font-bold">bound</span>' },
      { affix: '-free', meaning: 'without', example: 'sugar → sugar-<span class="font-bold">free</span>' },
      { affix: '-worthy', meaning: 'deserving of', example: 'trust → trust<span class="font-bold">worthy</span>' },
      { affix: '-ern', meaning: 'direction, location', example: 'north → north<span class="font-bold">ern</span>' },
    ],
  },
  {
    ...
    affixes: [
      ...
      { affix: '-esce', meaning: 'begin to', example: 'fluor → fluor<span class="font-bold">esce</span>' },
    ],
  },
  {
    ...
    affixes: [
      ...
      { affix: '-ways', meaning: 'in a manner/direction', example: 'side → side<span class="font-bold">ways</span>' },
      { affix: '-fold', meaning: 'multiplied by', example: 'two → two<span class="font-bold">fold</span>' },
    ],
  },
];
