    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-8">
        {[
          ...
          { icon: <Globe className="h-6 w-6 text-violet-600" />, value: '2 Tasks', label: 'Task 1 & Task 2' },
          { icon: <GraduationCap className="h-6 w-6 text-amber-500" />, value: 'Score 25+', label: 'Target Writing' },
        ].map((stat, i) => (
