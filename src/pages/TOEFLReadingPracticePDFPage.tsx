...
import { Download, Users, FileText, Globe, GraduationCap } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-8">
        {[
          ...
          { icon: <Globe className="h-6 w-6 text-violet-600" />, value: '10 Q&As', label: 'Practice Questions' },
          { icon: <GraduationCap className="h-6 w-6 text-amber-500" />, value: 'TOEFL iBT', label: 'Difficulty Level' },
        ].map((stat, i) => (
