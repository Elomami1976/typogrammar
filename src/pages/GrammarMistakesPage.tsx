  ...
  const categories = [
    ...
    },
    {
      ...
      links: [
        ...
        { to: "/grammar-mistakes/used-to-vs-be-used-to/", text: "Used to vs. Be Used to" },
      ]
    },
    {
      ...
      links: [
        ...
        { to: "/grammar-mistakes/very-vs-too-vs-so/", text: "Very vs. Too vs. So" },
        { to: "/grammar-mistakes/so-vs-such/", text: "So vs. Such" },
        { to: "/grammar-mistakes/still-vs-yet-vs-already/", text: "Still vs. Yet vs. Already" },
      ]
    },
    {
      ...
      links: [
        ...
        { to: "/grammar-mistakes/since-vs-for/", text: "Since vs. For" },
        { to: "/grammar-mistakes/during-vs-for-vs-while/", text: "During vs. For vs. While" },
        { to: "/grammar-mistakes/in-vs-on-vs-at-time-and-place/", text: "In vs. On vs. At (Time and Place)" },
        { to: "/grammar-mistakes/in-vs-on-vs-at-place/", text: "In vs. On vs. At (Place)" },
        { to: "/grammar-mistakes/to-vs-for/", text: "To vs. For" },
        { to: "/grammar-mistakes/by-vs-with/", text: "By vs. With" },
        { to: "/grammar-mistakes/about-vs-of/", text: "About vs. Of" },
      ]
    },
    {
  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-xl shadow-lg shadow-slate-200/50 border border-slate-200 dark:bg-slate-800/50 dark:border-slate-700 dark:shadow-slate-900/50">
        ...
        <section className="mt-12 p-6 bg-teal-50 rounded-xl dark:bg-teal-900/20">
