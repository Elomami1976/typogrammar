...
import { Download, Check, BookOpen, Target, Users, TrendingUp, HelpCircle, FileText, Award, ChevronRight, Lightbulb, Star, CheckCircle, Languages, BookMarked, MessageCircle } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
        {[
          ...
          { icon: <Star className="h-6 w-6 text-amber-500" />, value: '100', label: 'Idioms' },
        ].map((stat, i) => (
      ...
      <section className="mb-16" id="contents">
        ...
        <div className="bg-gradient-to-br from-yellow-50 to-teal-50 dark:from-yellow-900/20 dark:to-teal-900/20 rounded-xl p-8 shadow-md border-2 border-yellow-200 dark:border-yellow-700">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-slate-700 dark:text-slate-300">
            <div className="flex items-center gap-2"><ChevronRight className="h-4 w-4 text-amber-500 shrink-0" />Clear and simple meanings</div>
            <div className="flex items-center gap-2"><ChevronRight className="h-4 w-4 text-amber-500 shrink-0" />Natural example sentences</div>
            <div className="flex items-center gap-2"><ChevronRight className="h-4 w-4 text-amber-500 shrink-0" />Common usage contexts</div>
            <div className="flex items-center gap-2"><ChevronRight className="h-4 w-4 text-amber-500 shrink-0" />Perfect for exam preparation</div>
          </div>
        </div>
      </section>
