...
import { Download, Check, BookOpen, Users, HelpCircle, FileText, Award, ChevronRight, Star, Languages, BookMarked } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
        {[
          ...
          { icon: <Users className="h-6 w-6 text-violet-600" />, value: '50', label: 'Health Words' },
          { icon: <Star className="h-6 w-6 text-amber-500" />, value: 'Band 7+', label: 'Strategies' },
        ].map((stat, i) => (
